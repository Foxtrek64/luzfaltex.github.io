using luzfaltex.github.io.Infrastructure.Extensions;
using luzfaltex.github.io.Infrastructure.Services;
using Markdig;
...
public partial class MarkdownSection : FluentComponentBase
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            _jsModule = await JSRuntime.ComponentModule<MarkdownSection>();
        }
